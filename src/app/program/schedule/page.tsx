...
export default function Page() {
  ...
  const images: { src: string; alt: string; caption?: string }[] = [
    { src: '/program/schedule/program_image.jpg', alt: '프로그램' },
  ];
  ...
  useEffect(() => {
    ...
    const onKey = (e: KeyboardEvent) => e.key === 'Escape' && setLightboxIdx(null);
  ...
  return (
    <main className='mx-auto max-w-6xl px-4 py-10'>
      ...
      <section className='grid gap-6'>
        {images.map((img, i) => (
          <figure key={img.src} className='rounded-2xl border bg-white p-4 shadow-sm'>
            {/* 썸네일: 클릭 시 라이트박스 오픈 */}
            <button
              type='button'
        ...
        >
          ...
          <div className='relative max-h-[90vh] max-w-[95vw]' onClick={(e) => e.stopPropagation()}>
            ...
            <div
              ...
              <div
                style={{
                  width: baseSize.w ? (zoomed ? baseSize.w * SCALE : baseSize.w) : undefined,
                  height: baseSize.h ? (zoomed ? baseSize.h * SCALE : baseSize.h) : undefined,
                }}>
                <img
                  ref={imgRef}
