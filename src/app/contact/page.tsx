...
export default function Page() {
  ...
  return (
    <main className='mx-auto max-w-6xl px-4 py-8'>
      <SectionTitle icon='/icon.png' as='h1' className='text-2xl'>
        행사장소
      </SectionTitle>
      ...
      <section className='mt-8 rounded-2xl border bg-white p-6 shadow-sm'>
        <h2 className='mb-3 text-lg font-semibold'>오시는 길 </h2>
      ...
      <section className='mt-6 rounded-2xl border bg-white p-6 shadow-sm'>
        ...
        <div className='grid gap-2 text-sm text-gray-800'>
          <div className='flex items-center gap-2'>
            <span className='inline-block w-16 shrink-0 text-gray-600'>이메일</span>
            <a href='mailto:ksafm1@gmail.com' className='underline underline-offset-2'>
              {ORG.email}
            </a>
          </div>
          <div className='flex items-center gap-2'>
            <span className='inline-block w-16 shrink-0 text-gray-600'>전화</span>
            <a href='tel:07044177125' className='underline underline-offset-2'>
              {ORG.phone}
            </a>
          </div>
          <div className='flex items-start gap-2'>
            <span className='inline-block w-16 shrink-0 pt-0.5 text-gray-600'>주소</span>
